...
void MenuLista::mostrarMenu() {
    ...
    cout << "1. Agregar elemento a la lista (push)" << std::endl;
    cout << "2. Eliminar elemento de la lista (pop)" << std::endl;
    cout << "3. Ver el último elemento de la lista (top)" << std::endl;
...
void MenuLista::ejecutarOpcion(int opt) {
    ...
    switch (opt) {
        case 1:
            cout << "Opción: Agregar elemento a la lista (push)" << std::endl;
            cout << "Ingrese el número a agregar: ";
            cin >> num;
            lista->push(num);
            break;
        case 2:
            cout << "Opción: Eliminar elemento de la lista (pop)" << std::endl;
            lista->pop();
            break;
        case 3:
            cout << "Opción: Ver el último elemento de la lista (top)" << std::endl;
            cout << "El último elemento de la lista es: " << lista->top() << std::endl;
            break;
        case 4:
